  ...
  (
    ...
    const editor = useEditor({
      ...
      editorProps: {
        attributes: {
          class: cn(
            "flex flex-col min-h-[80px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50",
            editorClass,
          ),
        },
      },
    ...
    return (
      ...
      >
        <div className={cn("flex grow flex-col", innerDivClass)}>
          ...
          <EditorContent
            editor={editor}
            className="admin-blog shopify-html max-h-[80vh] min-h-20 overflow-y-scroll flex grow flex-col"
            ref={ref}
          />
        </div>
