  ...
  try {
    ...
    return {
      ...
      data: {
        ...
        shreeSuyagadangSutra:
          FrontendPlaylistDTOSchema.parse(shreeSuyagadangSutra),
        shreeNandiSutra: FrontendPlaylistDTOSchema.parse(shreeNandiSutra),
        shreeDashvaikalikSutra: FrontendPlaylistDTOSchema.parse(
          shreeDashvaikalikSutra
        ),
        shreeUttaradhyayanSutra: FrontendPlaylistDTOSchema.parse(
          shreeUttaradhyayanSutra
        ),
      },
