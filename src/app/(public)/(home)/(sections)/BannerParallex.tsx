...
const BannerParallex = () => {
    ...
    const s = useTransform(scrollY, [0, 500], [1.2, 1.4]);
    ...
    return (
        <div ref={ref} className='h-screen max-md:h-[80vh] w-screen overflow-hidden relative' >
            ...
            <motion.div style={{ scale: s }} className="absolute bottom-0 left-1/2 max-md:scale-150 max-md:bottom-10 -translate-x-1/2 w-full max-w-7xl">
            ...
            <motion.div
                ...
                style={{ scale: mainScale }} className="absolute top-20 left-1/2 max-sm:max-w-64 -translate-x-1/2 w-full max-w-xs">
