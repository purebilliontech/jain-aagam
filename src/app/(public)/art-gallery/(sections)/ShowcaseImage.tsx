    ...
    return (
        <div className="p-5">
            ...
            <div className="max-w-7xl mx-auto relative my-10">
                ...
                <Image src='/static/art/horizontal.png' alt='Showcase' width={500} height={500} className=' object-contain w-full h-full rounded-lg' />

                <div className="w-full h-full flex absolute top-0 left-0 z-50 bg-black/35">
